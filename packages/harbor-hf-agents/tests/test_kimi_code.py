"""Unit tests for the Kimi Code sandbox inference wrapper."""
...
from harbor_hf_agents.kimi_code import agent as kimi_code_agent
...
async def test_sandbox_route_injects_loopback_env(
    ...
    monkeypatch.setattr(kimi_code_agent, "use_sandbox_inference_route", use_route)
    agent = KimiCodeAgent(
        logs_dir=temp_dir,
